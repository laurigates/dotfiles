...
# Commented out because I'm testing with minimal user scoped MCP servers to debloat context
...
# claude mcp add --scope=user github -- go run github.com/github/github-mcp-server/cmd/github-mcp-server@latest stdio
