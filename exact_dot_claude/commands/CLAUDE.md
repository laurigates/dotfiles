...
| `/configure:mcp` | Configure MCP servers for project | Install and manage MCP servers from registry |
| `/configure:package-management` | Configure modern package managers | uv for Python, bun for TypeScript |
